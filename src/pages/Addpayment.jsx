    ...
    <>
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="w-full m-4 md:m-10">
          ...
          <h2 className="text-[28px] text-[#222222] font-medium mb-10">Add Payment Method</h2>
          <div className="mb-5">
          ...
          <div className="flex flex-col md:flex-row w-full mt-10 space-y-6 md:space-y-0 md:space-x-10">
