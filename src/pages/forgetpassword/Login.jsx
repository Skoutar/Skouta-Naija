...
const Login = () => {
  return (
    <div className="bg-white mt-[20px] w-full h-full mb-[50px]">
      ...
      <p className="w-auto h-[24px] mt-[30px] ml-[80%] text-[16px] font-normal leading-[24px] text-left">Dont have an acount? <Link to='/signup' className="text-mainColor">Signup</Link></p>
      ...
      <div className="flex items-center justify-center mt-[20px]">
        <p className="font-medium w-[160px] h-[auto] mr-[100px]">Remember me</p>
        <Link to='/forgetpassword' className="text-mainColor ">Forget Password?</Link>
      </div>
    </div>
  )
}
